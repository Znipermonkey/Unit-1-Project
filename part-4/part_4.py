...
#     choice = input("Choose 1  add a book.Choose 2 to see all your books. Choose 3 to exit. - ")
...
def main_menu(books_source):
    ...
    while active:
        ...
        if choice == "1":
            ...
            summed = sum([x['rating'] for x in books_source])
            y = 0
            for x in books_source:
                y = y + 1
